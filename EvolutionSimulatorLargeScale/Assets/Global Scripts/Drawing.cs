...
public class Drawing
{
    ...
    public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width, Texture2D texture)
    {
        ...
        GUI.DrawTexture(new Rect(pointA.x, pointA.y, 1, 1), texture);
